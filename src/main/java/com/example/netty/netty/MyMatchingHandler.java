...
//
//import com.example.netty.netty.entiy.Mage;
...
//            cmap.forEach((id, iom) -> {
//                try {
//                    if (id != this.sessionId) iomm.sead(mage);
//                } catch (Exception e) {
...
//                    if (InformationOperateMapMatching.queue.size() >= 2) {
//                        String tableId = UUID.randomUUID().toString();
//                        InformationOperateMapMatching iom1 = InformationOperateMapMatching.queue.poll().setTableId(tableId);
//                        InformationOperateMapMatching iom2 = InformationOperateMapMatching.queue.poll().setTableId(tableId);
